       ...
       <section class="main-slider">
        ...
        <div class="container">
            <div class="row">               
                ...
                <div class="col-md-6">
                   <div class="embed-responsive embed-responsive-16by9">
                            <img src="img/kedasi/about/shared.jpg" style="width:600px"></iframe>
                        </div> 
                </div>
            </div>
            ...
            <div class="row">               
                <div class="col-md-6">
                   <div class="embed-responsive embed-responsive-16by9">
                            <img src="img/kedasi/about/private.jpg" style="width:500px"></iframe>
                        </div> 
                </div>
                <div class="col-md-6">
            ...
            <div class="divide40"></div>
             ...
             <div class="row">               
                ...
                <div class="col-md-6">
                   <div class="embed-responsive embed-responsive-16by9">
                            <img src="img/kedasi/about/meeting.jpg" style="width:600px"></iframe>
                        </div> 
                </div>
            </div>
            <div class="divide40"></div>
            ...
            <div class="row">               
                <div class="col-md-6">
                   <div class="embed-responsive embed-responsive-16by9">
                            <img src="img/kedasi/about/outdoor.jpg" style="width:500px"></iframe>
                        </div> 
                </div>
                <div class="col-md-6">
                    <h3 class="heading">OUTDOOR LOUNGE</h3> 
                    <p class="dropcap">
                       Our outdoor lounge acts as a natural mixing space. 
                    </p>
                    <p><a href="#" class="btn btn-theme-bg">Read More</a></p><hr>
                </div>
            </div>
            ...
            <div class="row">               
                ...
                <div class="col-md-6">
                   <div class="embed-responsive embed-responsive-16by9">
                            <img src="img/kedasi/about/games.jpg" style="width:600px"></iframe>
                        </div> 
                </div>
            </div>
            <div class="divide40"></div>
