    ...
    <body>
        <div class="top-bar-wrap hidden-xs">
            <div class="container">
                <div class="top-bar">
                    <div class="pull-left">
                        +62 21 2940 1110 | ask@kedasi.co.id 
                    </div>
        ...
        <div class="navbar navbar-default navbar-static-top sticky" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php"><img src="img/kedasi/kedasi.png" style="width:150px" /></a>
                </div><!--.navbar header-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="packages-tomang.php">Tomang</a></li>
                                <li><a href="packages-tanjung-duren.php">Tanjung Duren</a></li>
                            </ul>
                        </li><!--.dropdown-->
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown">Private Offices <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#">Tomang</a></li>
                                <li><a href="#">Tanjung Duren</a></li>
                            </ul>
